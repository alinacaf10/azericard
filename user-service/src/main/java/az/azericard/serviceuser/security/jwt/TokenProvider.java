...
public interface TokenProvider {
    ...
    /**
     * Get {@link Authentication} which holds username and roles of {@link az.azericard.serviceuser.domain.entity.User}s
     *
     ...
     *
     * @param token a JWT token
     * @return {@link az.azericard.serviceuser.security.jwt.TokenValidityResponse} response
     */
